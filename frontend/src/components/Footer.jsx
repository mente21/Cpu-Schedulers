  ...
  return (
    <footer className="footer">
      <div className="container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <div className="flex flex-col items-center gap-6 text-center" style={{ width: '100%', justifyContent: 'center', alignItems: 'center' }}>
          ...
          >
            ...
            <p style={{ color: "#cbd5e1", textAlign: "center", margin: 0 }}>
              Schedulix — an interactive CPU scheduling simulator for
              visualizing and comparing scheduling algorithms such as Round
              Robin, FCFS, and SJF. Use the simulator to experiment with time
              quantum, arrival times, and priorities to understand scheduler
            ...
            >
              <span style={{ color: "#ffffff" }}>
                &copy; {new Date().getFullYear()} Schedulix
              </span>{" "}
              • Licensed under MIT
            </p>
          </div>
